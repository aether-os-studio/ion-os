...
#include "mm/alloc/area.hpp"
#include "mm/alloc/block.hpp"
#include "mm/alloc/freelist.hpp"
#include "mm/alloc/large-blk.hpp"
...
#pragma unroll
    ...
    freelist_put(&man->large_blk, (freelist_t)((char *)ptr + 2 * sizeof(size_t)));
    return true;
}
...
static bool mman_reqmem(mman_t man, size_t size)
{
    ...
    mman_pool_t pool = (mman_pool_t)((char *)mem + 2 * sizeof(size_t));
    ...
    freelist_put(&man->large_blk, (freelist_t)((char *)ptr));
    return true;
}
...
void *mman_alloc(mman_t man, size_t size)
{
    ...
    mman_pool_t pool = (mman_pool_t)blk_poolptr(ptr);
